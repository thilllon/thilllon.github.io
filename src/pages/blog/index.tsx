  ...
  return (
    <Layout>
      ...
      <motion.div variants={staggerHalf} initial="initial" animate="animate" exit="exit">
            ...
            {filteredSeries.map((series) => (
              <motion.div key={series.slug} variants={fadeInSlideToLeft}>
                <Link as={series.slug} href={`/blog/[slug]`}>
                  <div className="relative h-56 w-40 select-none rounded-lg bg-neutral-200 px-8 pb-12 pt-8 shadow-lg transition-all hover:scale-[1.01] hover:shadow-xl dark:bg-neutral-800">
        ...
        <motion.div className="mb-4 mt-16 flex items-end gap-2" variants={fadeInHalf}>
